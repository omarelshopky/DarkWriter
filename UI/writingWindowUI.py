...
# Form implementation generated from reading ui file '.\UI\writingWindow.ui'
#
...
"} ")
        ...
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(".\\UI\\../img/arrow-left.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        ...
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(".\\UI\\../img/arrow-right.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
    ...
    def retranslateUi(self, WritingWindow):
        ...
        self.titleLblL.setText(_translate("WritingWindow", "Dark Turkey"))
        self.titleLblR.setText(_translate("WritingWindow", "Writer"))
